...
### Script utilizado no TCC
- **Cluster - Modelo Não Hierárquico - Kmeans.py**  
  Implementação do modelo de clusterização não hierárquica (k-means) utilizado nas análises do trabalho.

### Scripts construídos, mas não utilizados na versão final
- **Cluster - Modelo Hierárquico Aglomerativo.py**  
